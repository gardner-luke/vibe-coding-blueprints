# 📊 Step 2: KPI Metric Cards

**Goal:** Add a row of 4 KPI cards below the header.

**Add to `app.py`:**

Create 4 columns with metric cards showing:
...
**Expected Result:** Four styled metric cards in a horizontal row below the header.
